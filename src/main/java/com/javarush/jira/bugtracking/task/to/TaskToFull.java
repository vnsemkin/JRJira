...
public class TaskToFull extends TaskToExt {
    ...
    public TaskToFull(Long id,
                      String code, String title, String description, String typeCode,
                      String statusCode, String priorityCode,
                      LocalDateTime updated, Integer estimate, CodeTo parent,
                      CodeTo project, CodeTo sprint,Set<String> tags, List<ActivityTo> activityTos) {
